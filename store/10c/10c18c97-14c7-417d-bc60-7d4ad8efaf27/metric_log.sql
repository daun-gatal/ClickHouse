ATTACH TABLE _ UUID '69fb304f-3655-4b0b-b1d1-4df748d6496b'
(
    ...
    `ProfileEvent_ColumnsCacheHits` UInt64 COMMENT 'Number of times a deserialized column was found in the columns cache.',
    `ProfileEvent_ColumnsCacheMisses` UInt64 COMMENT 'Number of times a deserialized column was not found in the columns cache.',
    `ProfileEvent_ColumnsCacheEvictedBytes` UInt64 COMMENT 'Number of bytes evicted from the columns cache.',
    `ProfileEvent_ColumnsCacheEvictedEntries` UInt64 COMMENT 'Number of entries evicted from the columns cache.',
    ...
    `CurrentMetric_ColumnsCacheBytes` Int64 COMMENT 'Total size of columns cache in bytes. The columns cache stores deserialized columns from MergeTree tables to avoid repeated decompression and deserialization.',
    `CurrentMetric_ColumnsCacheEntries` Int64 COMMENT 'Total number of entries in the columns cache.',
