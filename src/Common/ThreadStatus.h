...
public:
    ...
    ThreadGroupSwitcher(ThreadGroupPtr thread_group_, ThreadName thread_name, ProfileEvents::CountersPtr counters_scope_, bool allow_existing_group = false) noexcept;
    ~ThreadGroupSwitcher();

private:
    ThreadStatus * prev_thread = nullptr;
    ThreadGroupPtr prev_thread_group;
    ProfileEvents::CountersPtr prev_counters_scope;
    ThreadGroupPtr thread_group;
    ProfileEvents::CountersPtr counters_scope;
};
