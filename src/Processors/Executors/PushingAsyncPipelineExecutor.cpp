...
static void threadFunction(
    PushingAsyncPipelineExecutor::Data & data, ThreadGroupPtr thread_group, ProfileEvents::CountersPtr profile_counters_scope, size_t num_threads, bool concurrency_control)
{
    try
    {
        ThreadGroupSwitcher switcher(thread_group, ThreadName::PUSHING_ASYNC_EXECUTOR, profile_counters_scope);
