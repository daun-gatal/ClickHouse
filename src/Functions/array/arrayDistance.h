...
/// Specializations for LpDistance
template <> size_t FunctionArrayDistance<LpDistance>::getNumberOfArguments() const;
template <> ColumnNumbers FunctionArrayDistance<LpDistance>::getArgumentsThatAreAlwaysConstant() const;
template <> LpDistance::ConstParams FunctionArrayDistance<LpDistance>::initConstParams(const ColumnsWithTypeAndName & arguments) const;
