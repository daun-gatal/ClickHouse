...
/// Suppress non-numeric member functions — instantiated in greaterOrEqualsHalf3.cpp.
COMPARISON_EXTERN_NON_NUMERIC_TEMPLATES(GreaterOrEqualsOp, NameGreaterOrEquals)
