...
void registerAggregateFunctionsQuantileExactWeightedInterpolated(AggregateFunctionFactory &);
...
void registerAggregateFunctionUniqHLL12(AggregateFunctionFactory &);
void registerAggregateFunctionUniqExact(AggregateFunctionFactory &);
void registerAggregateFunctionUniqTheta(AggregateFunctionFactory &);
...
{
    {
        ...
        registerAggregateFunctionsQuantileExactWeightedInterpolated(factory);
        ...
        registerAggregateFunctionUniqHLL12(factory);
        registerAggregateFunctionUniqExact(factory);
        registerAggregateFunctionUniqTheta(factory);
        ...
        registerAggregateFunctionTimeseries2(factory);
