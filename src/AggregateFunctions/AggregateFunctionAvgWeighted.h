...
/// Second-level dispatch: for a given first type, dispatch on the second type.
#define AVG_WEIGHTED_TYPES(LINE) \
...
IAggregateFunction * createAvgWeightedSecondType(const IDataType & second_type, TArgs && ... args)
{
