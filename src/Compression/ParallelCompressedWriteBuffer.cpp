...
void ParallelCompressedWriteBuffer::nextImpl()
{
    ...
    pool.scheduleOrThrowOnError([this, my_current_buffer = current_buffer, thread_group = CurrentThread::getGroup(), profile_counters_scope = CurrentThread::getCountersScope()]
    {
        ThreadGroupSwitcher switcher(thread_group, ThreadName::PARALLEL_COMPRESSORS_POOL, profile_counters_scope);
